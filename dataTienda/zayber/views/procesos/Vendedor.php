				...
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="row">
						<div class="col-md-2 col-sm-2 col-xs-6">
							...
							<input type="text" class="form_input" id="IdFechaIn_PAGV" readonly>
						</div>
						<div class="col-md-2 col-sm-2 col-xs-6">
							<span class="claTexto">F.Fin</span></br>
							<input type="text" class="form_input" id="IdFechaFn_PAGV" readonly>
						</div>
						<div class="col-md-2 col-sm-2 col-xs-6">
					...
					<div class="row p-t-10">
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="table-responsive" id="IdContentRVPV">
								<table class="claTableReport" id="IdTableReportec_ReportPAGV">
									<thead><tr class="">
										<th>Pagar</th><th>VC</th><th>Empresa</th><th>Capital</th><th>Interes</th><th>Total</th><th>Fecha Limt.</th>
										<th>Ruc</th><th>R.S.</th><th>Monto</th><th>Mora</th><th>Total Pagar</th><th>Fecha Pago</th>
										<th>Detail</th>
...
<script src="./views/procesos/Vendedor.js"></script>
