...
<div class="col-xl-12 col-md-12 col-sm-12 col-xs-12">
	<div class="row marginManteReg">
		...
		<div class="col-xl-6 col-md-6 col-sm-6 col-xs-6 right">
			<button class="btn btn-success btn-round clr-verde" id="btnNewCategoria"><i class="fas fa-plus-circle"></i> Nuevo</button>
		</div>
	</div>
</div>
<div class="col-xl-12 col-md-12 col-sm-12 col-xs-12">
	<div class="row marginManteReg">
		<div class="table-responsive TablaBlancoF">
			<table class="claTableRegistro" id="IdTableManteCategoria">
				<thead><tr>
					<th>Editar</th>
					<th>Modelo</th>
					<th>Simbolo</th>
...
<script src="./views/mante/ManteCategoria.js"></script>
