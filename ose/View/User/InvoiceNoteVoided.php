<div class="container pt-5 pb-5">
    ...
    <div class="row mb-5">
        <div class="col-auto mr-auto">
            <h1>
                <span><i class="fas fa-list"></i> Comunicaciones de Baja NC ND</span>
            </h1>
        </div>

        <div class="col-auto d-flex align-items-center">
            <div class="btn-group">
                <a href="<?= FOLDER_NAME . '/InvoiceNoteVoided/NewSaleNoteVoided' ?>" class="btn btn-primary"><i class="fas fa-plus"></i> Nuevo</a>
            </div>
        </div>
    </div>
    ...
    <div class="card mb-3">
        <div class="card-body">
            ...
            <div class="collapse" id="collapseAdvancedOptions">
                <form action="<?= FOLDER_NAME . '/InvoiceNoteVoided'?>" method="GET" class="mt-4">
                <div class="form-row">
                ...
                <div class="btn-group">
                    ...
                    <a href="<?= FOLDER_NAME . '/InvoiceNoteVoided'?>" class="btn btn-light">Mostrar Todo</a>
                </div>
            </form>
            </div>
        </div>
        ...
        <div class="card-body">
            ...
            <div class="table-responsive mb-4">
                <table class="table table-striped table-sm">
                    ...
                    <tbody>
                        <?php
                            foreach ($parameter['saleNoteVoided']['data'] ?? [] as $key => $row ):
                                ...
                                <td>
                                    <div class="btn-group ">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <a class="dropdown-item text-danger" href="<?= FOLDER_NAME . '/InvoiceNoteVoided/ResendSaleNoteVoided?SaleNoteVoidedId=' . $row['sale_note_voided_id'] ?>"> <i class="fas fa-file-alt"></i> Consultar o recuperar constancia</a>
<!--                                            <a class="dropdown-item" href="--><?//= FOLDER_NAME . '/InvoiceNoteVoided/ResendSaleNoteVoided?SaleNoteVoidedId=' . $row['sale_note_voided_id'] ?><!--"> Consultar estado a la SUNAT</a>-->
                                        </div>
                                    </div>
                                </td>
                            </tr>
            ...
            <?php
                $currentPage = $parameter['saleNoteVoided']['current'] ?? 1;
                $totalPage = $parameter['saleNoteVoided']['pages'] ?? 1;
                $limitPage = $parameter['saleNoteVoided']['limit'] ?? 10;
                $additionalQuery = '';
                $linksQuantity = 3;
