                ...
                <div class="row mb-2">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control form-control-sm" id="invoiceGlobalDiscountPercentage" name="invoice[global_discount_percentage]" value="<?= $parameter['invoice']['global_discount_percentage'] ?? '' ?>">
                        </div>
                        <div class="form-group">
                            <label for="invoiceTotalCharge"><i class="icon-minus-circle2 mr-2"></i> Otros Cargos:</label>
                            <input type="number" class="form-control form-control-sm <?= ($parameter['error']['total_charge'] ?? false) ? 'is-invalid' : '' ?>"
