    ...
    <form action="<?= FOLDER_NAME . '/Invoice/NewInvoice' ?>" method="POST" class="mt-4 mb-4">
        ...
        <div class="card mb-3 bg-white">
            <div class="card-body">
                ...
                <div class="font-weight-bold">Detalle Documento: </div>
                <hr>
                <div class="row mb-2 mt-4">
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label for="invoiceGlobalDiscountPercentage"><i class="icon-percent mr-2"></i> Descuento Global (en porcentaje %):</label>
                            <input type="number" class="form-control" id="invoiceGlobalDiscountPercentage" name="invoice[global_discount_percentage]" value="<?= $parameter['invoice']['global_discount_percentage'] ?? '' ?>">
                        </div>
                        <div class="form-group">
                            <label for="invoiceTotalCharge"><i class="icon-minus-circle2 mr-2"></i> Otros Cargos:</label>
                            <input type="number" class="form-control <?= ($parameter['error']['total_charge'] ?? false) ? 'is-invalid' : '' ?>"
                                   id="invoiceTotalCharge" name="invoice[total_charge]" value="<?= $parameter['invoice']['total_charge'] ?? '' ?>">
                        </div>

                        <div class="form-group">
                            <label for="invoiceObservation"><i class="icon-notebook mr-2"></i> Observaciones</label>
                            <textarea type="text" class="form-control" id="invoiceObservation" name="invoice[observation]" cols="30" rows="4"><?= $parameter['invoice']['observation'] ?? '' ?></textarea>
                        </div>
                        ...
                        <div class="collapse <?php echo ($parameter['invoice']['itinerant_enable'] ?? false) ? 'show' : ''  ?>" id="collapseItinerant">
                            <div class="row">
                                <div class="form-group col-sm-6">
                                    <label for="locationItinerantLocation"><i class="icon-sphere mr-2"></i> UBIGEO</label>
                                    <select class="geographicalLocationSearch <?= ($parameter['error']['itinerant_location'] ?? false) ? 'is-invalid' : ''  ?>"
                                             id="locationItinerantLocation" data-width="100%" name="invoice[itinerant_location]">
                                ...
                                <div class="form-group col-sm-6">
                                    <label for="invoiceItinerantAddress"><i class="icon-home2 mr-2"></i> Dirección</label>
                                ...
                                <div class="form-group col-sm-6">
                                    <label for="invoiceItinerantUrbanization"><i class="icon-location3 mr-2"></i> Urbanizacion</label>
                ...
                <div class="form-group text-center">
                    <button type="submit" name="commit" id="jsInvoiceFormCommit" class="btn btn-primary">
                        <i class="icon-floppy-disk mr-2"></i> Emitir Documento Electrónico
                    </button>
                </div>
